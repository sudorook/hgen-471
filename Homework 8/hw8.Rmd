...
### (b)
Suppose in a case-control study, samples in cases and controls are sequenced at
different sites, which use different sequencing platforms at different
...
posterior probabilities? We also know that the frequency of T in the
population is 0.2. Hint: first determine the possible genotypes of the mother
