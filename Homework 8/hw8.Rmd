...
Prior(non-reference heterozygote) $\sim 0.01 * 2/3$

Prior(non-reference homozygote) $\sim 0.01 * 1/3$
...
\begin{align}
P(D|G=TC) &= (1-\epsilon)^2 (1-\frac{\epsilon}{3})^4 \\
  &= \big( \frac{1}{2}[(1-\epsilon) + \frac{\epsilon}{3}] \big)^6 \\
  &= 0.01384129
\end{align}
